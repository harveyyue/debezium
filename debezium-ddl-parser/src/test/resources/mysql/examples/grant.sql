...
GRANT APPLICATION_PASSWORD_ADMIN, AUDIT_ABORT_EXEMPT, AUTHENTICATION_POLICY_ADMIN, FIREWALL_EXEMPT, FLUSH_OPTIMIZER_COSTS, FLUSH_STATUS, FLUSH_TABLES, FLUSH_USER_RESOURCES, GROUP_REPLICATION_STREAM, PASSWORDLESS_USER_ADMIN, READ_MASK, ROLE_ADMIN, SENSITIVE_VARIABLES_OBSERVER, SHOW_ROUTINE, XA_RECOVER_ADMIN ON *.* TO 'global_dba'@'10.21.42.43' WITH GRANT OPTION;
